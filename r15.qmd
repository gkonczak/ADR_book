...
Przed rozpoczęciem pracy niezbędne jest załadowanie wykorzystywanych w tym rozdziale bibliotek. Realizuje to następująca komenda:
...
: Formaty wyjściowe dokumentów w **Quarto** {#tbl-formaty}
...
Źródło: https://quarto.org/docs/output-formats/all-formats.html
...
W celu utworzenia dokumentu **Quarto** w **RStudio** należy z menu programu kolejno wybrać: 
...
Wprowadza się je w poniżej opisany sposób.
