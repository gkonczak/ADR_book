...
W @tbl-p przedstawiono funkcje pozwalające utworzyć różne typy wykresów.
...
| densityplot    | Estymator gęstości rozkładu |
...
| xyplot         | Wykresy rozrzutu i wykresy szeregów czasowych  |
...
4. Wykorzystaj histogram do zbadania rozkładu zmiennej *Solar.R*. Użyj argumentu *breaks* do zmiany liczby przedziałów.
